                    ...
                    <div class="m-0">
                        ...
                        <form method="POST" action="{{ route('change_password', $user->id) }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="new_password_confirmation" class="form-label small">Confirmer le Nouveau Mot
                                        de Passe</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="sexe" name="sexe" required>
                                    <option value="Masculin" {{ $user->sexe == 'Masculin' ? 'selected' : '' }}>Masculin
                                    </option>
                                    <option value="Féminin" {{ $user->sexe == 'Féminin' ? 'selected' : '' }}>Féminin
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="situation_matrimoniale" name="situation_matrimoniale"
                                    ...
                                    <option value="Célibataire"
                                        {{ $user->situation_matrimoniale == 'Célibataire' ? 'selected' : '' }}>Célibataire
                                    </option>
                                    <option value="Marié(e)"
                                        {{ $user->situation_matrimoniale == 'Marié(e)' ? 'selected' : '' }}>Marié(e)
                                    </option>
                                    <option value="Divorcé(e)"
                                        {{ $user->situation_matrimoniale == 'Divorcé(e)' ? 'selected' : '' }}>Divorcé(e)
                                    </option>
                                    <option value="Veuf(ve)"
                                        {{ $user->situation_matrimoniale == 'Veuf(ve)' ? 'selected' : '' }}>Veuf(ve)
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="date_naiss" name="date_naiss"
                                    value="{{ $user->date_naiss }}" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="lieu_naiss" name="lieu_naiss"
                                    value="{{ $user->lieu_naiss }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="pays_residence" name="domicile"
                                    value="{{ $user->domicile }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
