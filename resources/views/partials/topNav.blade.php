    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item"><a class="nav-link" href="{{ route('dashboard') }}" style="font-weight: bold;">DASHBOARD</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('gestion_offres.index') }}" style="font-weight: bold;">OFFRES
                        D'EMPLOI</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('candidature.index') }}"
                        style="font-weight: bold;">CANDIDATURES</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('demande_stages.index') }}" style="font-weight: bold;">DEMANDES DE STAGE</a>
                </li>
                <li class="nav-item"><a class="nav-link" href="{{ route('settings') }}"
                        style="font-weight: bold;">ADMINISTRATION</a></li>
            </ul>
            <!-- Profil utilisateur -->
            <ul class="navbar-nav">
                @guest
